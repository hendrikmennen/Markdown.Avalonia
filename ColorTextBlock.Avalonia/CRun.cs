...
namespace ColorTextBlock.Avalonia
{
    ...
    public class CRun : CInline
    {
            ...
            double remainWidth)
        {
            ...
            if (remainWidth == entireWidth) return Create(Text, entireWidth);
            ...
            {
                return layout.TextLines.Count == 1 ? Create(Text, layout) : Create(Text, entireWidth);
            }

            var firstLineText = Text.Substring(firstLine.FirstTextSourceIndex, firstLine.Length);
